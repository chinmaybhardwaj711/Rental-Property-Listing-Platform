const sampleListings = [
  ...
  },
  {
    ...
    description:
      "Step out onto the sandy beach from this luxurious beachfront condo.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Stay in a piece of history in Amsterdam's iconic district.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Have an entire island to yourself for an unforgettable experience.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Escape to the picturesque English countryside.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Enjoy breathtaking mountain views in the Canadian Rockies.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Step into the glamour of the 1920s in South Beach.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Escape to a tropical paradise with a private infinity pool.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Experience luxury in the middle of the desert in this opulent oasis.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Experience futuristic living in this stunning luxury dome.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description:
      "Enjoy a serene stay on a traditional houseboat in Kashmir.",
    image: {
      filename: "listingimage",
